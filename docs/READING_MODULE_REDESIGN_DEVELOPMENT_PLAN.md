...
> 历史说明：本计划已经按 F-10 完成并关闭，不应作为新一轮 UI 小修清单继续追加。Reader 2.0 的书库、专业排版、完整纸张/主题、字体扩展、批注和视觉重构改由 [F-12 Reader 2.0 开发计划](READING_MODULE_2_0_DEVELOPMENT_PLAN.md) 管理；F-10 回归仍是 F-12 的基础门禁。
