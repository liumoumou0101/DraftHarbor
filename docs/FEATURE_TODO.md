...
| 编号 | 功能 | 状态 | 依赖 | 完成标准 | 下一步 |
| --- | --- | --- | --- | --- | --- |
| F-12 | Reader 2.0 专业小说阅读器 | 进行中：F-12.1 主线已落地，F-12.2 基础能力开发中 | F-10 Reader Document/Locator/Store/Transfer、桌面设计系统、项目投影 | Reader 可以作为独立桌面小说阅读器长期使用；具备正式书库、专业排版、完整纸张/主题、分页/翻页、导航、书签、高亮、批注和字体扩展基础；选择后可安全转写作、资料库和工作流 | 继续冻结 Preferences v2、字体目录、阅读方案与批注契约，再推进正式书库首页和专注阅读壳 |
...
- [ ] F-12.2：Preferences v2、阅读方案、主题、字体目录/Provider、批注和历史契约（基础排版偏好已接入，契约与多字体扩展开发中）。
- [ ] F-12.3：正式书库首页、继续阅读、项目作品、本地书籍和书籍详情。
- [ ] F-12.4：专注阅读壳、HUD、全局 chrome 协调、焦点状态和样式拆分。
- [ ] F-12.5：快捷外观、外观工作室、六个完整主题、纸张材质和单字体多字体架构演练。
- [ ] F-12.6：中文分页质量、翻页输入、动效 Adapter、状态栏与进度。
- [ ] F-12.7：导航中心、书签升级、高亮、批注和位置历史。
- [ ] F-12.8：选择模式与写作、资料库、工作流转交。
- [ ] F-12.9：自动化、视觉 QA、无障碍、性能、恢复、构建和安装版发布验收。
- [ ] F-12.10：用户字体文件安装与管理；F-12.11：TTS/自动阅读；F-12.12：EPUB 格式扩展。
