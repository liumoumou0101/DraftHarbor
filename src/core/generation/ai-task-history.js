(function (root, factory) {
    ...
    function createAITaskRecord(input = {}) {
        ...
        return {
            ...
            outputArtifactType: clonePlain(task.outputArtifactType || {}),
    ...
    function toLegacyGenerationRecord(taskRecord, overrides = {}) {
        ...
        legacy.aiTask = {
            ...
            capabilityVersion: record.capabilityVersion || 1,
            outputArtifactType: clonePlain(record.outputArtifactType || {}),
